        ...
        <main>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    ...
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      <span className="block">DnD is a big time sink</span>
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 block pb-2">
                        let's change that
                      </span>
                    </h1>
                    <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      Nat20 allows users to play Dungeons and Dragons in a whole
                      new way, without sessions and on your own time. Save time
                      and enjoy full campaigns the right way.
                    </p>
                    <div className="mt-10 sm:mt-12">
                      <div className="sm:flex">
                        <div className="mt-3 sm:mt-0">
                          ...
                          >
                            Give it a shot... Add us to a Discord Server
                          </button>
                        </div>
                      </div>
                    </div>
          ...
          <div className="relative bg-white py-16 sm:py-24 lg:py-32">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
              ...
              <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                Players and DMs alike can track inventory, edit their character
                sheet, and record their game. Simple as that.
              </p>
              <div className="mt-12">
